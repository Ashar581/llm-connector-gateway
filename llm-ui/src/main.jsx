...
import { bootstrapApiBaseUrl } from "./services/apiService";
import router from "./routers/routes";
import "./index.css";

// Resolve the API base URL (override → same-origin auto-detect → env
// default — see apiService.jsx) before anything renders, so every
// component mounts already pointed at the right backend. This is what
// lets the exact same build work standalone (talking to a separately
// hosted API) and embedded in Java's static resources (talking to the
// API at its own origin, whatever host/port that happens to be).
bootstrapApiBaseUrl().finally(() => {
